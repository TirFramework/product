...
namespace Tir\Store\Currency\Support;
...
class Money implements JsonSerializable
{
    ...
    {
        return new self($amount, Stg::get('default_currency'));
    }
    ...
    //Edit by Tirdad temporary escape exchange
    public function convertToCurrentCurrency($currencyRate = null)
    {
        return new self($this->amount, Stg::get('default_currency'));
